...
<div dir="rtl">
  ...
  برای نمونه ، هوانگ و همکاران برای شناسایی کپچا از شبکه عصبی بازگشتی (RNN) ، SVM و یادگیری ماشین افراطی (ELM) استفاده کرد [1].
  تروونگ و همکاران برای تأمین امنیت سیستم ، یک سیستم تازه محافظت شده مانند Interactive CAPTCHA (iCAPTCHA) طراحی کرده است [2].
</div>
