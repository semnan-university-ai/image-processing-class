...
<img width="400" height="400" src="Result/f.PNG">
  ...
  <h3 align="center">شکل 5. ماژول احتمال را می توان با درجه کج به دو قسمت تقسیم کرد: (الف) از -45 تا 0 درجه و (ب) از 0 تا 45 درجه.</h3>
</p>
</div>
...
در آزمایشات ، بیش از دو هزار مورد captcha را آزمایش شده است. چهار تا هفت عدد در هر تصویر captcha پنهان شده است. همانطور که در شکل 5 نشان داده شده است ،به طور تصادفی 100 مورد برای ایجاد ماژول احتمال به دست آمده است . شکل 6 در این مطالعه چارچوب تشخیص captcha را نشان می دهد. از آنجا که هدف تشخیص موثراعداد می باشد ، از برخی روشهای پردازش تصویر برای تقسیم اعداد در تصاویر captcha استفاده می شود.  برای محاسبه شباهت بین مجموعه های آموزشی و مجموعه تست ها از معادله تطبیق ، مانند eqn. (4) استفاده شده است. نتیجه آزمایشی در شکل 7 نشان داده شده است. ارزیابی کمی نشان داده است که  روش  پیشنهادی به طور متوسط به دقت  81.05٪ برای بیش از دو هزار تصویر کپچا رسیده است.  </div>
