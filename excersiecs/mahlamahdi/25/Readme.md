...
<div dir="rtl">
  ...
  یان و همکاران از روش شمارش پیکسل برای بررسی  تصاویر captcha کمک گرفته اند وبه  موفقیت بیش از 90٪ رسیده اند [4]. Yahoo! Captcha از کاراکترهای پی در پی استفاده می کرد که می توانستند در اوایل حمله مقاومت کنند. گائو و همکارانش در مطالعه خود به   موفقیت 78٪ ونرخ موفقیت کلی 54.7٪ رسیده اند[6].
</div>
