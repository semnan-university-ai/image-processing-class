...
است که در آن R، G و B با مقادیر مولفه‌های قرمز، سبز و آبی در تصویر رنگی متناظر هستند. باینری سازی تصویر انجام می‌شود. الگوریتم Otsu برای بدست آوردن مقدار آستانه بهینه هر تصویر استفاده می‌شود. - پیکسل های بالاتر از مقدار آستانه به ۲۵۵ تنظیم می‌شوند و پیکسل های زیر مقدار آستانه به ۰ تنظیم می‌شوند. فرمول g(‏x، y)=(1/M)‏*∑▒〖f 〗(‏x / y)‏ = (‏y، x)‏gبرای تنظیم مقدار پیکسل فعلی به عنوان مقدار میانگین هشت پیکسل همسایه استفاده می‌شود. در نهایت، تصویر بخش‌بندی شده و فرآیند خاص در شکل ۱ نشان‌داده شده‌است.
...
کپچا که به صورت تصادفی تولید می‌شود دارای ویژگی‌های اعوجاج و چسبندگی متوسط است که با روش‌های سنتی تشخیص کپچا قابل‌تشخیص نیست. ما ۱۰۰۰۰ تصویر کپچا را به عنوان مجموعه آموزشی و ۲۰۰۰ را به عنوان مجموعه آزمایشی تولید می‌کنیم.  کاراکترهایی هستند که توسط تصویر به علاوه شماره سریال متوالی نمایش داده می‌شوند تا از ظاهر شدن خطا با همان تصویر جلوگیری شود.قالب نام گذاری، کاراکترهایی هستند که توسط تصویر به علاوه شماره سریال متوالی نمایش داده می‌شوند تا از ظاهر شدن خطا با همان تصویر جلوگیری شود. تصویر نمونه در شکل ۶ نشان‌داده شده‌است.
