...
است که در آن R، G و B با مقادیر مولفه‌های قرمز، سبز و آبی در تصویر رنگی متناظر هستند. باینری سازی تصویر انجام می‌شود. الگوریتم Otsu برای بدست آوردن مقدار آستانه بهینه هر تصویر استفاده می‌شود. - پیکسل های بالاتر از مقدار آستانه به ۲۵۵ تنظیم می‌شوند و پیکسل های زیر مقدار آستانه به ۰ تنظیم می‌شوند. فرمول g(x,y)=(1/M)*∑▒〖f 〗(x,y) برای تنظیم مقدار پیکسل فعلی به عنوان مقدار میانگین هشت پیکسل همسایه استفاده می‌شود. در نهایت، تصویر بخش‌بندی شده و فرآیند خاص در شکل ۱ نشان‌داده شده‌است.
