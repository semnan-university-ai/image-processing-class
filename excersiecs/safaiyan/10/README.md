...
<div dir="rtl">
     ...
     -برای ایجاد یک کپچای 4 عددی 4 عدد تصادفی ایجاد کردیم
     
     -سپس عدد تصادفی ایجاد شده را با کمک دستور if به فایل همان عدد نسبت دادیم
     
     -سپس 4 عدد را در تصویر قرار دادیم و تصویر را نمایش دادیم
