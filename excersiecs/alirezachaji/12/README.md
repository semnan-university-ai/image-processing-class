...
subplot(2,2,1);imshow(p);                % تصویر اصلی را نمایش می دهد
subplot(2,2,2);imshow(a);                % تصویر را پس از اعمال نویز نشان می دهد
...
subplot(2,2,3);imshow(a);                % تصویر حاصل از فیلتر میانگین را نمایش می دهیم                          
...
subplot(2,2,4);imshow(a);                % تصویر حاصل از فیلتر میانه را نمایش می دهیم
```
Function
```ruby
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
