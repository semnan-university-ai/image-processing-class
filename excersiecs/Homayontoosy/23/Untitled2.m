...
img = imread('d:/../../../benchmark/fruits.png');
R = img(:, :, 1);
G = img(:, :, 2);
B = img(:, :, 3);
...
subplot(2,2,1),imshow(img),title('Orginal picture');

subplot(2,2,2),imshow(RHimg),title('Red-Chanel');

subplot(2,2,3),imshow(GHimg),title('Green-Chanel');

subplot(2,2,4),imshow(BHimg),title('Blue-Chanel');